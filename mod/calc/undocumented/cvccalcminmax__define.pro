...
;
;--------------------------------------------------------------------
FUNCTION cvcCalcMinMax::Init, in_sInputs, in_sOutputs, in_hLogFile
...
FUNCTION cvcCalcMinMax::Run
    self->printLog, "(cvcCalcTimeMean::Run) Started..."
;    ; get inputs
    ...
    self->printLog, "(cvcCalcMaxMax::Run) Get data..."
...
;    self->printLog, "(cvcCalcMinMax::Run) Started..."
...
;        
;    ; main loop for all time segments
;    self->printLog, "(cvcCalcMinMax::Run) Get data..."

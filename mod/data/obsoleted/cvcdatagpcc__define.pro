...
;
;  PURPOSE:
;    Low-level class. Provides access to GPCC data. 
;
;  INHERITS:
;    cvcError
;
...
;
;--------------------------------------------------------------------
FUNCTION cvcDataGPCC::Init, in_sDatasetDesc, in_modulePath, in_oGlobal
...
;+
; :Description:
;    Reads data array from GPCC-file. Accepts time range.
;
; :Params:
...
; :Author: garry
;-
FUNCTION cvcDataGPCC::Read, in_aArea, in_aTimeRng, in_level, out_sData
...
END
;--------------------------------------------------------------------
FUNCTION cvcDataGPCC::Prepare, in_varName, in_sTimeSeg, in_aLevel, in_sRegion

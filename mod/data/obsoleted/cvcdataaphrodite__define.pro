...
;
;--------------------------------------------------------------------
FUNCTION cvcDataAPHRODITE::Init, in_sDatasetDesc, in_modulePath, in_oGlobal
...
; :Author: garry
;-
FUNCTION cvcDataAPHRODITE::Read, in_aArea, in_aTimeRng, in_level, out_sData
...
END
;--------------------------------------------------------------------
FUNCTION cvcDataAPHRODITE::Prepare, in_varName, in_sTimeSeg, in_aLevel, in_sRegion
...
END
;--------------------------------------------------------------------
PRO cvcDataAPHRODITE__define

    struct = { cvcDataAPHRODITE, $
               INHERITS cvcData $
             }
END
...
;
;--------------------------------------------------------------------
FUNCTION cvcDataNOAA::Init, in_sDatasetDesc, in_modulePath, in_oGlobal
...
;+
; :Description:
;    Reads data array from NOAA-file. Accepts time range.
;
; :Author: garry
;-
FUNCTION cvcDataNOAA::Read, in_aArea, in_aTimeRng, in_level, out_sData
...
END
;--------------------------------------------------------------------
FUNCTION cvcDataNOAA::Prepare, in_varName, in_sTimeSeg, in_aLevel, in_sRegion
